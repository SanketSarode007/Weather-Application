...
public class WeatherApp {
    ...
    public static JSONObject getWeatherData(String locationName){
        ...
        try{
            ...
            //,so we need to get the index our current hour
    ...
    public static JSONArray getLocationData(String locationName){
        //replace any whitespace in location name to + to adhere to APIs to request format
        locationName = locationName.replaceAll(" ","+");

        //build API url with location parameter
        String urlString = "http://geocoding-api.open-meteo.com/v1/search?name="+locationName+"&count=10&language=en&format=json";
        try{
    ...
    public static String getCurrentTime(){
        ...
        //format data to be 2023-09-02T00:00(this is how it is read in the API)
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH':00'");

        //format amd print the current data nad time
